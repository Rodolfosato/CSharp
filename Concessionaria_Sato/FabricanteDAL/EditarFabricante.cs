...
{
    public partial class EditarFabricante : Form
    {
        ...
        private void EditarFabricante_Load(object sender, EventArgs e)
        {
        ...
        private void btnAlterar_Click(object sender, EventArgs e)
        {
            ...
            {
                fabricante.AlterarFabricante(Convert.ToInt32(txtBuscar.Text), txtFabricante.Text);
                MessageBox.Show("Fabricante alterado!");
                this.Close();
            }
            else
            {
                MessageBox.Show("Favor digitar o novo fabricante!");
            }
        }
    }
}
